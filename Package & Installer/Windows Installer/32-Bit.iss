...
#define MyAppVersion "1.5.0 (32-Bit)"
...
[Files]
Source: "K:\Qt\Advanced_Photo\Binary\1.5.0\Windows\32-Bit\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
