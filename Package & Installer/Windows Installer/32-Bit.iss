...
#define MyAppVersion "1.4.1 (32-Bit)"
...
[Files]
Source: "K:\Development\Qt\Advanced_Photo\Binary\1.4.1\Windows\32-Bit\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
