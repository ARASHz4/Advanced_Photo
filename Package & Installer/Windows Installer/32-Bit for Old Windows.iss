...
OnlyBelowVersion=6.0.6001
DefaultGroupName=Advanced Photo
DisableProgramGroupPage=yes
OutputDir=K:\Development\Qt\Advanced_Photo\Binary\1.4.1\Windows\With Installer\Advanced Photo 1.4.1 for old Windows
...
[Files]
Source: "K:\Development\Qt\Advanced_Photo\Binary\1.4.1\Windows\32-Bit MinGW\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
